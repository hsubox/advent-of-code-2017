...
function day1_part1(input) {
  return input.split('')
    .filter((n, idx, arr) => {
      let nextDigit = arr[(idx + 1) % arr.length];
      return n === nextDigit;
    })
    .map(Number)
    .reduce((a, b) => a + b, 0);
...
assert.equal(day1_part1('1122'), 3);
assert.equal(day1_part1('1111'), 4);
assert.equal(day1_part1('1234'), 0);
assert.equal(day1_part1('91212129'), 9);
console.log(day1_part1(input)); // 1029

function day1_part2(input) {
  return input.split('')
    .filter((n, idx, arr) => {
      let halfwayAroundDigit = arr[(idx + (arr.length / 2)) % arr.length]
      return n === halfwayAroundDigit;
    })
    .map(Number)
    .reduce((a, b) => a + b, 0);
}

assert.equal(day1_part2('1212'), 6);
assert.equal(day1_part2('1221'), 0);
assert.equal(day1_part2('123425'), 4);
assert.equal(day1_part2('123123'), 12);
assert.equal(day1_part2('12131415'), 4);
console.log(day1_part2(input)); // 1220
